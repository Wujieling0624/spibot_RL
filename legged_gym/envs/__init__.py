...
from legged_gym.envs.s1.s1_config import S1RoughCfg, S1RoughCfgPPO
# from legged_gym.envs.s1.s1_env import S1Robot
...
task_registry.register( "s1", LeggedRobot, S1RoughCfg(), S1RoughCfgPPO())
